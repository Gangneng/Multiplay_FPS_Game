...
public class MatchManager : MonoBehaviourPunCallbacks, IOnEventCallback
{
    ...
    public float wiatAfterEnding = 5f;
    ...
    // 유니티 내 객체를 사용할 수 있는 상태면 enable, 아니면 disable.
    public override void OnEnable()
    {
        // 이벤트 발생 시 OnEvent로 콜백
        PhotonNetwork.AddCallbackTarget(this);
    }

    public override void OnDisable()
    {
        // 연결 끊김 시 에러 발생 차단을 위해 콜백 시스템 삭제.
    ...
    {
        yield return new WaitForSeconds(wiatAfterEnding);
